            ...
            <li class="hassubs active"><a href="javascript:void(0)">Reports</a>
                <ul class="dropdown">
                    ...
                    <li class="subs hassubs active"><a href="javascript:void(0)">Fee&ensp;Paid</a>
                        <ul class="dropdown">
                            <li class="subs active"><a href="freport1.php">Branch</a></li>
...
?>
    ...
    if(isset($_POST["report"])){
        if(isset($_POST["report"])){
            ...
            $course=$_POST["course"];
            $sql="SELECT * FROM feetable where  (feedate BETWEEN '$startdate' AND '$enddate') AND course = '$course' AND  feedate <> ''";
        }
        if($_POST['startdate'] == ""){
            $course=$_POST["course"];
            $sql="SELECT * FROM feetable where course = '$course' AND  feedate <> ''";
        }
