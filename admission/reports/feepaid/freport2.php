...
<head>
    ...
    <meta charset='UTF-8' />
    <title>Fee Branch Mark Report</title>
</head>
                ...
                <ul class="dropdown">
                    ...
                    <li class="subs hassubs active"><a href="javascript:void(0)">Fee&ensp;Paid</a>
                        <ul class="dropdown">
                            ...
                            <li class="subs active"><a href="freport2.php">Branch&ensp;Mark</a></li>
                            <li class="subs sub2"><a href="freport3.php">Branch_Community</a></li>
...
?>
    ...
    if(isset($_POST["report"])){
        if(isset($_POST["report"])){
            ...
            $course=$_POST["course"];
            $sql="SELECT * FROM feetable where  (feedate BETWEEN '$startdate' AND '$enddate') AND course = '$course' AND  feedate <> '' ORDER BY cutoff DESC";
        }
        if($_POST['startdate'] == ""){
            $course=$_POST["course"];
            $sql="SELECT * FROM feetable where course = '$course' AND  feedate <> '' ORDER BY cutoff DESC";
        }
