                ...
                <ul class="dropdown">
                    <li class="subs hassubs active"><a href="javascript:void(0)">Registration</a>
                        <ul class="dropdown">
                            ...
                            <li class="subs active"><a href="selectreport2.php">Branch</a></li>
...
?>
    ...
    if(isset($_POST["report"])){
        if( isset($_POST["startdate"]) && isset($_POST["enddate"]) ){
            ...
            $course=$_POST["course"];
            $sql="SELECT * FROM registration where (regdate BETWEEN '$startdate' AND '$enddate') AND course = '$course'";
        }
        if($_POST['startdate'] == ""){
            $course=$_POST["course"];
            $sql="SELECT * FROM registration where course = '$course'";
        }
