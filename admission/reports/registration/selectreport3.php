...
<head>
    ...
    <meta charset='UTF-8' />
    <title>Reg Branch Cmty Rep</title>
</head>
                ...
                <ul class="dropdown">
                    <li class="subs hassubs active"><a href="javascript:void(0)">Registration</a>
                        <ul class="dropdown">
                            ...
                            <li class="subs active"><a href="selectreport3.php">Branch_Community</a></li>
...
?>
    ...
    if(isset($_POST["report"])||isset($_GET["page"])){
        if(isset($_POST["report"])){
            ...
            $course=$_POST["course"];
            $community=$_POST["community"];
            $sql="SELECT * FROM registration where (regdate BETWEEN '$startdate' AND '$enddate') AND course = '$course' AND community='$community' ORDER BY total DESC";
        }
        if($_POST['startdate'] == ""){
            $course=$_POST["course"];
            $community=$_POST["community"];
            $sql="SELECT * FROM registration where course = '$course' AND community='$community' ORDER BY total DESC";
        }
