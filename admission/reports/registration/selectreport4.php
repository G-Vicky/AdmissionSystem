...
<head>
    ...
    <meta charset='UTF-8' />
    <title>Reg Branch Mark Rep</title>
</head>
                ...
                <ul class="dropdown">
                    <li class="subs hassubs active"><a href="javascript:void(0)">Registration</a>
                        <ul class="dropdown">
                            ...
                            <li class="subs active"><a href="selectreport4.php">Branch&ensp;Mark</a></li>
...
?>
    ...
    if(isset($_POST["report"])){
        if(isset($_POST["report"])){
            ...
            $course=$_POST["course"];
            $sql="SELECT * FROM registration where (regdate BETWEEN '$startdate' AND '$enddate') AND course = '$course' ORDER BY total DESC";
        }
        if($_POST['startdate'] == ""){
            $course=$_POST["course"];
            $sql="SELECT * FROM registration where course = '$course' ORDER BY total DESC";
        }
