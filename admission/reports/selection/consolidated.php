...
<head>
    <link rel='stylesheet' type='text/css' href='../registration/cstyle.css' />
    ...
    <meta charset='UTF-8' />
    <title>Sel Consolidated Report</title>
</head>
                ...
                <ul class="dropdown">
                    ...
                    <li class="subs hassubs active"><a href="javascript:void(0)">Selection</a>
                        <ul class="dropdown">
                            ...
                            <li class="subs active"><a href="../selection/consolidated.php">Consolidated</a></li>
                        </ul>
                    </li>
        ...
        ?>
            ...
            <script>
                function exporttoexcel(tableID, filename = '') {
                    ...
                    filename = filename ? filename + '.xls' : 'Sel_ConRep.xls';
