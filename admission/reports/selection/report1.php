            ...
            <li class="hassubs active"><a href="javascript:void(0)">Reports</a>
                <ul class="dropdown">
                    ...
                    <li class="subs hassubs active"><a href="javascript:void(0)">Selection</a>
                        <ul class="dropdown">
                            <li class="subs active"><a href="report1.php">Branch</a></li>
...
?>
    ...
    if(isset($_POST["report"])){
        if(isset($_POST["report"])){
            ...
            $course=$_POST["course"];
            $sql="SELECT * FROM feetable where (selectiondate BETWEEN '$startdate' AND '$enddate') AND course = '$course'";
        }
        if($_POST['startdate'] == ""){
            $course=$_POST["course"];
            $sql="SELECT * FROM feetable where course = '$course'";
        }
