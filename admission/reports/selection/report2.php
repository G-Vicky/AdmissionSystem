...
<head>
    ...
    <meta charset='UTF-8' />
    <title>Sel Branch Cmty Report</title>
</head>
                ...
                <ul class="dropdown">
                    ...
                    <li class="subs hassubs active"><a href="javascript:void(0)">Selection</a>
                        <ul class="dropdown">
                            ...
                            <li class="subs active"><a href="report2.php">Branch_Community</a></li>
                            <li class="subs sub2"><a href="report3.php">Branch&ensp;Mark</a></li>
                    ...
                    <li class="subs hassubs"><a href="javascript:void(0)">CV Report</a>
                        <ul class="dropdown">
                            <li class="subs"><a href="../cv/cvphp.php">CV Periodical</a></li>
                            <li class="subs sub2"><a href="../cv/cvbranch.php">CV Branch</a></li>
                            <li class="subs"><a href="../cv/consolidated.php">Consolidated</a></li>
                        </ul>
                    </li>
...
?>
    ...
    if(isset($_POST["report"])||isset($_GET["page"])){
        if(isset($_POST["report"])){
            ...
            $course=$_POST["course"];
            $community=$_POST["community"];
            $sql="SELECT * FROM feetable where (selectiondate BETWEEN '$startdate' AND '$enddate') AND course = '$course' AND community='$community' ORDER BY cutoff DESC";
        }
        if($_POST['startdate'] == ""){
            $course=$_POST["course"];
            $community=$_POST["community"];
            $sql="SELECT * FROM feetable where course = '$course' AND community='$community' ORDER BY cutoff DESC";
        }
