...
<body>
    <div class="main">
       <?php
        if($_SESSION["user"] == "secretary"){
            ...
            <li><a href="dailyrep.php">Today&ensp;Rep</a></li>
        ...
        <br style="clear: both;">';
            ...
            <li class="hassubs active"><a href="javascript:void (0)">Secretary</a>
                <ul class="dropdown">
                    <li class="subs active"><a href="report.php">Report</a></li>
                    <li class="subs"><a href="dailyrep.php">Today&ensp;Rep</a></li>
                </ul>
            </li>
    ...
    if(mysqli_num_rows($result) > 0){
     ...
     ?>
            <div class="excelform">
                <form action="rexcel.php" method="post">
